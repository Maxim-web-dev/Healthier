...
export const photoRequest = async (photoId, accessToken) => {
	...
	await axios(config)
		...
		.catch(error => console.log('Error in the photoRequest function: ', error))
